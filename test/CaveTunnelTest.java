...
/**
 * Test class for Model.CaveTunnel.
 */
public class CaveTunnelTest {
  ...
  public void testToString() {
    Assert.assertEquals("Model.CaveTunnel{type: Cave, treasureList=[], matrixIndex=null,"
                    + " monsterList=[], weaponList=[]}", new CaveTunnel().toString());
  }
}