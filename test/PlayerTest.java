...
public class PlayerTest {
  ...
  public void testToString() {
    ...
    Assert.assertEquals("Model.Player{currLocation=[0, 0], playerTreasureList=[],"
            + " isDead=false, weaponsList=[CROOKED_ARROW, CROOKED_ARROW, CROOKED_ARROW]}",
            p1.toString());
  }
}