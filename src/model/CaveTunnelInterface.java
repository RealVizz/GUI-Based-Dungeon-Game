...
/**
 * This Model.CaveTunnelInterface keeps  all the public behaviours of a Cave and Tunnels.
 */
public interface CaveTunnelInterface {
  ...
  /**
   * Clears Model.Treasure of the cave.
   */
   ...
   *
   * @param weapon The weapons provided (Must be from Model.WeaponEnum).
   */
